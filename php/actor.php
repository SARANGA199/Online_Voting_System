...
<?php
include('header.php');
$_SESSION["logsession"] = 1;
?>
<br><br><br><br>


<center>
<h1>Most Popular Actor of the Year</h1>
</center>
...
<div class="main">
    ...
    <div class="row">
        ...
        $candidateQuery = 'SELECT * FROM candidate WHERE category_id = 1';
...
<div style="margin: 0 auto; width: fit-content">
    <a href="actress.php" class="next">Next &raquo;</a>
