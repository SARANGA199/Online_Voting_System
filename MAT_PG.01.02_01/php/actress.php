...
<div class="main">
    <center>
        <h1>Most Popular Actress of the Year</h1>
    </center>
    ...
    <div class="row">
        ...
        $candidateQuery = 'SELECT * FROM candidate WHERE category_id = 2';
    ...
    <br>
    <div style="margin: 70px auto; width: fit-content">
        <a href="actor.php" class="previous">&laquo; Previous</a>
        <a href="singer.php" class="next">Next &raquo;</a>
